...
// Message items created with a call on a Thread will be destroyed with the Thread.
    ...
    'd: 'q
{
    ...
    /// Return toplevel messages, oldest first.
    ///
    /// Wraps `notmuch_thread_get_toplevel_messages`.
